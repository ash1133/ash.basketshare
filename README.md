>На момент написания не получил информации по пункту "Указание action параметра для определения перехода по ссылке в настройках."
>
...
Код толком не причесан, само ядро было накидано за ~3 часаа в машине на парковке, остальное "причесывание" и мало-мальское тестирование (там-же на парковке) ~2 часа. 
Но врятли кто-то будет до этого места будет читать
